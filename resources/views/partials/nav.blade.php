<nav
    x-data="{
        ...
        toggle(){ this.open = !this.open; this.open ? this.lock() : this.unlock(); },
        close(){ this.open = false; this.unlock(); }
    }"
    ...
    <div class="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between gap-3">
        ...
        <a href="{{ route('home') }}" class="flex items-center gap-4 group select-none focus:outline-none focus-visible:outline-none">
            ...
            <div class="hidden sm:block leading-tight">
                <div class="text-xl font-bold font-mono bg-gradient-to-r from-emerald-400 via-cyan-300 to-emerald-400 bg-clip-text text-transparent">
                    BAPPA SUTRADHAR
                </div>
...
<template x-teleport="body">
    <div x-show="open" class="fixed inset-0 z-[9999] md:hidden">
        ...
        <!-- Panel (slide only) -->
        <div
            class="absolute right-0 top-0 h-full w-[84%] max-w-[360px]
