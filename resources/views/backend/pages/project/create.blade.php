...
@section('content')
    ...
    <div class="mt-4 rounded-md glass cyber-glow p-6 relative">
        ...
        <form method="POST" action="{{ route('admin.project.store') }}" class="mt-6 grid md:grid-cols-2 gap-5" enctype="multipart/form-data">
            @csrf
            ...
            <div class="md:col-span-2">
                ...
                <div id="mainImagePreview"
                    ...
                    <div class="relative rounded-md border border-white/10 bg-white/5 overflow-hidden">
                        ...
                        <div id="mainImagePreviewCap"
                            class="px-2 py-1 text-[10px] font-mono text-slate-300 truncate">
                        </div>

                        <div class="absolute top-1 right-1 text-[10px]
