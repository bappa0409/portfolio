...
use App\Jobs\SyncGithubReposJob;
...
class WebsiteController extends Controller
{
    ...
    //     /*
    //     |--------------------------------------------------------------------------
    //     | GitHub repos background fetch system
    //     |--------------------------------------------------------------------------
    //     */
    ...
    //         $githubRepos = Cache::get($cacheKey);

    //         if (!$githubRepos) {

    //             if (!Cache::has('github_sync_running')) {

    //                 Cache::put('github_sync_running', true, now()->addMinutes(10));

    //                 SyncGithubReposJob::dispatch();
    //             }
